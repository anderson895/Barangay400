...
<head>
    ...
    <title>Complains Request | Barangay System</title>
    <!-- plugins:css -->
...
document.addEventListener("DOMContentLoaded", function() {
    Swal.fire({
        ...
        showConfirmButton: true
                ...
                $count_sql = "SELECT COUNT(*) as total FROM tbl_compgriev c WHERE $where_clause";
                ...
                $sql = "SELECT c.complaint_id, c.res_id, c.user_id, c.dateFiled, 
c.caseNumber, c.complainant, c.respondent, c.victim, 
c.witness, c.natureOfCase, c.document_path,
c.status, c.created_at
FROM tbl_compgriev c
WHERE $where_clause
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                                    <p class="card-title mb-0">Barangay Complain Requests</p>
                                    <div class="ml-auto">
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php if ($canEdit): ?>
                                                                 <button class="btn btn-warning btn-sm" data-toggle="modal"
                                                                    data-target="#editModal<?php echo $row['complaint_id']; ?>">
                                                   ...
                                                   <div class="modal fade" id="viewComplainModal<?php echo $row['complaint_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel" aria-hidden="true">
                                                    ...
                                                    ?>">
                                                                                ...
                                                                                <div class="document-preview text-center p-3">
                                                                                    ...
                                                                                    if (in_array(strtolower($file_ext), ['jpg', 'jpeg', 'png', 'gif'])): ?>
                                                                                        <div class="img-container border p-2 mb-3">
                                                                                            <img src="../dist/assets/images/uploads/complaint-documents/<?php echo $row['document_path']; ?>"
                                                                                                class="img-fluid" alt="Document">
                                                                                        </div>
                                                                                        <a href="../dist/assets/images/uploads/complaint-documents/<?php echo $row['document_path']; ?>"
                                                                                            target="_blank"
                                                        ...
                                                        <div class="modal fade"
                                                            id="editModal<?php echo $row['complaint_id']; ?>" tabindex="-1"
                                                                ...
                                                                <div class="modal-content shadow-lg border-0">
                                                                    ...
                                                                    <form action="update_complain.php" method="POST">
                                                                        <div class="modal-body py-4">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label
                                                                                    for="status<?php echo $row['complaint_id']; ?>">Update
                                                                                    Status</label>
                                                                                <select class="form-control" name="status"
                                                                                    id="status<?php echo $row['complaint_id']; ?>"
                                                                                    required>
