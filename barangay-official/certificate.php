...
<head>
    ...
    <title>Certification Request | Barangay System</title>
    <!-- plugins:css -->
                                                                                ...
                                                                                <div class="document-preview text-center p-3">
                                                                                    ...
                                                                                    if (in_array(strtolower($file_ext), ['jpg', 'jpeg', 'png', 'gif'])): ?>
                                                                                        <div class="img-container border p-2 mb-3">
                                                                                            <img src="../dist/assets/images/uploads/certification-documents/<?php echo $row['document_path']; ?>"
                                                                                                class="img-fluid" alt="Document">
                                                                                        </div>
                                                                                        <a href="../dist/assets/images/uploads/certification-documents/<?php echo $row['document_path']; ?>"
                                                                                            target="_blank"
