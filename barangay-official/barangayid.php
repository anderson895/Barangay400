    ...
    document.addEventListener("DOMContentLoaded", function() {
        Swal.fire({
            ...
            showConfirmButton: true
                    ...
                    $sql = "SELECT b.BID_id, b.res_id, b.user_id, b.first_name, b.last_name, b.middle_name, 
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="info-group mb-3">
                                                                                        ...
                                                                                        <p class="font-weight-bold mb-2"><?php echo htmlspecialchars($detail['first_name'] . ' ' . $detail['last_name']);?></p>
                                                                                    </div>
                                                                                    <div class="info-group mb-3">
                                                                                    ...
                                                                                    <div class="info-group mb-3">
                                                                                        <label class="text-muted small text-uppercase">Birthdate</label>
