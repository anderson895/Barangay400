                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div class="export-buttons">
                                        <a href="export.php?format=pdf" class="btn btn-danger mb-2">
                                            <i class="fa-solid fa-file-pdf"></i> Export PDF
                                        </a>
                                        <a href="export.php?format=excel" class="btn btn-success mb-2">
                                                ...
                                                <?php while ($row = $result->fetch_assoc()): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button class="btn btn-info btn-sm" data-toggle="modal" title="View Details" 
