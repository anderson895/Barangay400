...
$username = "Guest";
$image = "https://barangay400.com/default_image.png"; // Assuming default image name
$first_name = "";
$last_name = "";
$mobile = "";
$email = "";
...
<head>
    ...
    <title>Barangay Blotter Request | Barangay System</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="modal fade" id="BlotterModal" tabindex="-1" role="dialog" aria-labelledby="BlotterModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <form action="add_blotter.php" method="POST" enctype="multipart/form-data" novalidate id="blotterForm" class="needs-validation">
                ...
                if (isset($_GET['success'])) {
                    $successMessages = [
                        1 => "Blotter Submitted Successfully"
                    ];
...
document.addEventListener("DOMContentLoaded", function() {
    Swal.fire({
        ...
        showConfirmButton: true
                ...
                // Enhanced search: Get all column names from the tbl_blotter table
                ...
                $count_sql = "SELECT COUNT(*) as total FROM tbl_blotter b
     WHERE $where_clause";
                ...
                // Fetch blotter requests query
                $sql = "SELECT b.blotter_id, b.user_id, b.complainant, b.respondent, 
b.victim, b.witness, b.natureOfCase, b.status, b.document_path, b.created_at, b.dateFiled
FROM tbl_blotter b
WHERE $where_clause
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                                    <p class="card-title mb-0">Barangay Blotter Request</p>
                                    <div class="ml-auto">
                                        ...
                                        ?>">
                                                        ...
                                                        <td>
                                                            <button class="btn btn-info btn-sm" data-toggle="modal"
                                                                data-target="#viewBlotterModal<?php echo $row['blotter_id']; ?>">
                                                    ...
                                                    <!-- View Modal -->
                                                    <div class="modal fade" id="viewBlotterModal<?php echo $row['blotter_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg" role="document">
                                                            <div class="modal-content shadow-lg border-0">
                                                                <!-- Enhanced Header with gradient background -->
                                                                <div class="modal-header bg-gradient-primary text-white py-3">
                                                                    <h5 class="modal-title font-weight-bold" id="viewModalLabel">
                                                                        <i class="fas fa-file-alt mr-2"></i>Blotter Request Details
                                                                    </h5>
                                            ...
                                            <?php else: ?>
                                                <tr>
                                                    <td colspan="7" class="text-center">No blotter reports found</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
